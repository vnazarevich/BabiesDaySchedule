...
public class TinyDB {
    ...
    public ArrayList<Schedule> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Schedule> objects =  new ArrayList<Schedule>();

    	for(String jObjString : objStrings){
    		Schedule value  = gson.fromJson(jObjString,  Schedule.class);
    		objects.add(value);
    	}
    	return objects;
    }
// My class
    public ArrayList<Schedule> getListObject (String key){
        Gson gson = new Gson();
        ...
        for(String jObjString : objStrings){
            Object value  = gson.fromJson(jObjString,  Schedule.class);

            objects.add((Schedule)value);
        }
        Log.w("+++ TinyDB ", "from getListObject ->  String key= "+key +"list.size()=" + objects.size());
        return objects;
    }
...
//    }
    ...
    public void putListObject(String key, ArrayList<Schedule> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Schedule obj : objArray){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
        Log.w("+++  TinyDB ", " from getListObject ->  String key= "+key + "objStrings.size()=" + objStrings.size());
    }
